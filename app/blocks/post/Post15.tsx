        ...
        <div className="container">
          <div className="mx-auto flex max-w-5xl flex-col items-center gap-5">
            ...
            <p className="text-center text-muted-foreground lg:text-lg">
              ...
              team&apos;s productivity. Learn about the latest tools and
              features designed to enhance efficiency, reduce manual tasks, and
          ...
          <div className="relative mx-auto mt-12 grid max-w-6xl gap-8 lg:grid-cols-4">
            ...
            <div className="prose sticky top-8 hidden h-fit rounded-lg border p-6 lg:block">
