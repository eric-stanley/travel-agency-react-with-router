...
const Content2 = () => {
  return (
    <>
      <section className="py-32 px-[1.5rem] lg:px-[5rem]">
          ...
          <div>
            ...
            <section className="prose mb-8">
              ...
              <Alert>
                ...
                <AlertDescription>
                  You can quickly create content by using our bulk upload
                  feature or content templates.
                </AlertDescription>
              </Alert>
            </section>
            <section className="prose mb-8">
              ...
              <ol>
                ...
                <li>
                  Click the <strong>options menu</strong> (three dots) and
